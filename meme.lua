...
Tab.info:AddTextBox({
  ...
  Tab.info:AddTextBox({
    ...
    Tab.main:AddDropdown({
      Name = "select sea",
      Description = "",
      Options = {"low","medium","high","extreme","Crazy","????"},
      Default = "????",
      Callback = function(Value)
        ran = Value
      end
...
Tog:Callback(function(Value)
  _G.AutoNear = Value
            ...
            adfsad:Callback(function(Value)
...
local rada = Tab.main:AddToggle({
    Name = "random cframe",
    Description = "do not turn it off",
    Default = true
  })
  rada:Callback(function(Value)
    _G.randomse = Value
  end)
if First_Sea then
...
while task.wait() do
    ...
    for i,v in pairs (game.Workspace.Enemies:GetChildren()) do
        ...
        then
            ...
            wait(0.4)
            Tween(v.HumanoidRootPart.CFrame * CFrame.new(15,25,0))
            wait(0.3)
            Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,25,15))
            wait(0.2)
            Tween(v.HumanoidRootPart.CFrame * CFrame.new(15,25,-15))
            wait(0.1)
            Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
        until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not _G.AutoBone
        end 
    elseif Auto_Law then
        if v.Name == "Order" then
            repeat wait(1.75)
                ...
                wait(0.1)
                Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
            until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not Auto_Law
        end
            ...
            if v.Name == "Diablo" or v.Name == "Deandre" or v.Name == "Urban" then
                repeat wait(1.75)
                   ...
                   Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,25,0))
                    ...
                    wait(0.1)
                    Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
                until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not _G.AutoElite
            end
        end
    elseif AutoHallowSycthe then
        if string.find(v.Name , "Soul Reaper") then
            repeat wait(1.75)
               ...
               Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,25,0))
                ...
                wait(0.1)
                Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
            until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not AutoHallowSycthe
        end
    ...
    if v.Name == _G.SelectBoss then
        repeat wait(1.75)
           ...
           Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,25,0))
            ...
            wait(0.1)
            Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
        until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not _G.AutoBoss
    end
elseif _G.CakePrince then
    if v.Name == "Cake Prince" or v.Name == "Dough King" then
            repeat wait(1.75)
               ...
               Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,25,0))
                ...
                wait(0.1)
                Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
            until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not _G.CakePrince
        elseif v.Name == "Baking Staff" or v.Name == "Head Baker" or v.Name == "Cake Guard" or v.Name == "Cookie Crafter" then
            repeat wait(1.75)
                Tween(v.HumanoidRootPart.CFrame * CFrame.new(15,25,15))
                wait(0.5)
               Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,25,0))
                ...
                wait(0.1)
                Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
            until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not _G.CakePrince or game:GetService("ReplicatedStorage"):FindFirstChild("Cake Prince") or game:GetService("ReplicatedStorage"):FindFirstChild("Dough King")
        end
    elseif _G.CastleRaid then
       if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 5000 then
        repeat wait(1.75)
            ...
            wait(0.1)
            Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
        until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not _G.CastleRaid or not game.Workspace.Enemies:FindFirstChild(v.Name)
    end
elseif _G.AutoLevel then
    if v.Name == Ms then
        repeat wait(1.75)
            Tween(v.HumanoidRootPart.CFrame * CFrame.new(15,25,15))
            wait(0.5)
           Tween(v.HumanoidRootPart.CFrame * CFrame.new(0,25,0))
            ...
            wait(0.1)
            Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
        until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not _G.AutoLevel
    end
elseif _G.AutoNear then
   if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 5000 then
    repeat wait(1.75)
        Tween(v.HumanoidRootPart.CFrame * CFrame.new(15,25,15))
        wait(0.5)
        ...
        wait(0.1)
        Tween(v.HumanoidRootPart.CFrame * CFrame.new(-15,25,15))
    until not _G.randoms or not v.Parent or v.Humanoid.Health <= 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not _G.AutoNear or not game.Workspace.Enemies:FindFirstChild(v.Name)
   end
end
    end
    end
